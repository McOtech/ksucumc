                      ...
                      <div class="form-group row">
                        <div class="col-sm-12">
                            <a href="javascript:void(0)">
                                <img id="newMinistryImage" onclick="document.querySelector('#newMinistryLogo').click()" class="img-profile rounded-circle d-block m-auto" style="height: 250px; width: 250px" src="{{ asset('storage/default/avatar.png')}}">
                            </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <form class="user" enctype="multipart/form-data" action="{{ route('cohort.update', ['cohort' => $cohort->id])}}" method="POST">
                                                ...
                                                @method('PATCH')
                                                    ...
                                                    <div class="col-sm-12">
                                                        <a href="javascript:void(0)">
                                                            <img id="updateMinistryImage_m_{{$cohort->id}}" onclick="document.querySelector('#updateMinistryLogo_m_{{$cohort->id}}').click()" class="img-profile rounded-circle d-block m-auto" style="height: 150px; width: 150px" src="{{ asset('' . $cohort->image) ?? asset('storage/default/avatar.png')}}">
                                                        </a>
